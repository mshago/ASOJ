...
db.define_table('submission',
        ...
        Field('code_stdout', 'text', label = 'Mensaje'),
        Field('score','double',default=0.0, label = 'Puntuación')
    )
...
db.define_table('problems_by_contest',
    Field('contest_id','reference  contest', label = "Evento"),
    Field('problem_id','reference  problem', label = "Problema"),
)
...
db.define_table('src_test_files', Field('your_code', 'text'))
db.src_test_files.your_code.requires = IS_NOT_EMPTY()
